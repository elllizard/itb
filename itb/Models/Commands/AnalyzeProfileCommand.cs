...
{
    public class AnalyzeProfileCommand : Command
    {
        public override string Name => "🧐 Analyze Profile";
        public override string Path => "/home/analyze";
        ...
        public override async Task Init(Update update, INotificationsService notificationsService)
        {
            ...
            try
            {
                ...
                {
                    _keyboard = new AnalyzeAuthorizedKeyboard();
                }
                else
                {
            ...
            catch (Exception _checkException)
            {
                ...
                try
                {
                    List<StatisticModel> _statistics =
                        await notificationsService.GetStatisticService().ReadAsync(update.Message.Text);
